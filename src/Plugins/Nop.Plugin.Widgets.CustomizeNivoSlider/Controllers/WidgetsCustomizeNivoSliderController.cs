...
namespace Nop.Plugin.Widgets.CustomizeNivoSlider.Controllers
{
    [AuthorizeAdmin]
    [Area(AreaNames.Admin)]
    [AutoValidateAntiforgeryToken]
    public class WidgetsCustomizeNivoSliderController : BasePluginController
    {
        ...
        public WidgetsCustomizeNivoSliderController(ILocalizationService localizationService,
        ...
        public async Task<IActionResult> Configure()
        {
            ...
            var nivoSliderSettings = await _settingService.LoadSettingAsync<CustomizeNivoSliderSettings>(storeScope);
            ...
            return View("~/Plugins/Widgets.CustomizeNivoSlider/Views/Configure.cshtml", model);
        }
