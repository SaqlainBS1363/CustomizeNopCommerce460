...
using Nop.Plugin.Widgets.CustomizeNivoSlider.Infrastructure.Cache;
using Nop.Plugin.Widgets.CustomizeNivoSlider.Models;
using Nop.Services.Configuration;
using Nop.Services.Media;
using Nop.Web.Framework.Components;

namespace Nop.Plugin.Widgets.CustomizeNivoSlider.Components
{
    public class WidgetsCustomizeNivoSliderViewComponent : NopViewComponent
    {
        ...
        public WidgetsCustomizeNivoSliderViewComponent(IStoreContext storeContext, 
        ...
        public async Task<IViewComponentResult> InvokeAsync(string widgetZone, object additionalData)
        {
            ...
            var nivoSliderSettings = await _settingService.LoadSettingAsync<CustomizeNivoSliderSettings>(store.Id);
            ...
            return View("~/Plugins/Widgets.CustomizeNivoSlider/Views/PublicInfo.cshtml", model);
        }
